<template>
  <main id="cgu">
    <section>
      ...
      <span>En vigueur au 01/10/2020</span>
      <p>
      ...
      <p>
        https://kinderkeepers.herokuapp.com/ se réserve le droit de modifier
    ...
    <section>
      ...
      <p>
        ...
        https://kinderkeepers.herokuapp.com/ est assurée par Karima Krachai,
        domicilié 3 avenue de savigny. Numéro de téléphone est 0660450694
        Adresse e-mail Karima.krachai@gmail.com. L'hébergeur du site
        https://kinderkeepers.herokuapp.com/ est la société Heroku, dont le
    ...
    <section>
      ...
      <p>
        Le site https://kinderkeepers.herokuapp.com/ permet à l'Utilisateur un
        accès gratuit aux services suivants : Le site internet propose les
        services suivants : Site qui permet à ses utilisateurs de poster des
        annonces de babysitting. Le site est accessible gratuitement en tout
        ...
        et ses coordonnées, notamment son adresse email. 1 Pour accéder aux
        ...
        la responsabilité de https://kinderkeepers.herokuapp.com/. Dans ces cas,
        l’Utilisateur accepte ainsi ne pas tenir rigueur à l’éditeur de toute
        interruption ou suspension de service, même sans préavis. L'Utilisateur
        a la possibilité de contacter le site par messagerie électronique à
    ...
    <section>
      ...
      <p>
        ...
        l'informatique, aux fichiers et aux libertés. Le site est déclaré à la
        CNIL sous le numéro _______________. En vertu de la loi Informatique et
        Libertés, en date du 6 janvier 1978, l'Utilisateur dispose d'un droit
        d'accès, de rectification, de suppression et d'opposition de ses données
        personnelles. L'Utilisateur exerce ce droit : · via un formulaire de
    ...
    <section>
      ...
      <p>
        ...
        https://kinderkeepers.herokuapp.com/ sont réputées fiables mais le site
        ne garantit pas qu’il soit exempt de défauts, d’erreurs ou d’omissions.
        2 Les informations communiquées sont présentées à titre indicatif et
        général sans valeur contractuelle. Malgré des mises à jour régulières,
        le site https://kinderkeepers.herokuapp.com/ ne peut être tenu
        ...
        responsabilité. Le site https://kinderkeepers.herokuapp.com/ ne peut
    ...
    <section>
      ...
      <p>
        ...
        https://kinderkeepers.herokuapp.com/. Ce dernier n’a pas de contrôle sur
    ...
    <section>
      ...
      <p>
        ...
        https://kinderkeepers.herokuapp.com/. Les cookies ne contiennent pas
        ...
        visite de l’Utilisateur, d’autres restent. L’information contenue dans
        les cookies est utilisée pour améliorer le site
        https://kinderkeepers.herokuapp.com/. En naviguant sur le site,
    ...
    <section>
      ...
      <p>
        Le site permet aux membres de publier les contenus suivants : annonces.
        ...
        publications et se réserve le droit de refuser leur mise en ligne, 3
        sans avoir à s’en justifier auprès du membre. Le membre reste titulaire
        de l’intégralité de ses droits de propriété intellectuelle. Mais en
